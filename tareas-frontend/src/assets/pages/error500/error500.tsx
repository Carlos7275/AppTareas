...
export default function Error500() {
  return <>
  <div className="main-error-page" data-aos="fade-up">
    <svg
    ...
    >
      ...
      <g fill="none" fill-rule="evenodd">
        <path  d="M0 0H1366V800H0z" transform="translate(-448 -158)" />
        <g>
    ...
    <h1 className="error-title text-body">
    ¡Woops! <br/>Algo ha salido mal :(
    </h1>
    <h2 className="error-subtitle">
      ¡Intente ingresar más tarde!
    </h2>
    <a onClick={()=>window.location.reload()} className="link" role="button">Actualizar</a>
